  ...
  return (
    ...
    <div className="pt-10">
      <Menu as="div" className="inline-block text-left">
        <div>
          <Menu.Button className="inline-flex justify-center items-center px-4 py-2 text-lg font-semibold text-white red-body hover:bg-red-400  focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 rounded-lg mt-6">
            Instructors
          </Menu.Button>
        </div>
        <Transition
        ...
        >
          <Menu.Items className="absolute z-10 left-10 right-0 w-56 mt-2 origin-top-right red-body divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
